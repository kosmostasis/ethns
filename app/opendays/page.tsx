...
export const metadata: Metadata = {
  title: "Ethereum NS | May 16th Open Day",
  description:
    "A open day event for Genesis Month at Network School with guest speakers from leading EVM chains and protocols.",
  robots: {
    index: false,
    follow: false,
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          <div className={styles.dateButtons} aria-label="Event dates">
            <Link className={styles.dateButton} href="/opendays" aria-current="page">
              May 16th
            </Link>
